...
class HomePage extends StatelessWidget {
  final List<Item> items = [
    Item(name: 'Sugar', price: 5000, image: 'rajagula.jpg', stock: 10, rating: 4.5),
    Item(name: 'Salt', price: 2000, image: 'rajagaram.jpg', stock: 20, rating: 4.0),
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomAppBar(
        child: Padding(
          ...
          child: Text('Farhan Ramazain - 2141720209'),
        ),
     ),
 );
 }
